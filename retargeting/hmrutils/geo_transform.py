...
from hmrutils.pylogger import Log
from pytorch3d.transforms import euler_angles_to_matrix
import hmrutils.matrix as matrix
from einops import einsum, rearrange, repeat
from hmrutils.geo.quaternion import qbetween
...
def triangulate_point(Ts_w2c, c_p2d, **kwargs):
    from hmrutils.geo.triangulation import triangulate_persp

    print("Deprecated, please import from hmrutils.geo.triangulation")
    return triangulate_persp(Ts_w2c, c_p2d, **kwargs)


def triangulate_point_ortho(Ts_w2c, c_p2d, **kwargs):
    from hmrutils.geo.triangulation import triangulate_ortho
